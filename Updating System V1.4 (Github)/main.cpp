...
int main() {
    ...
    while (true) {
        ...
        cout << "9. Delete first 10 rows from Price Sheet\n";
        cout << "10. Unmerge columns I & J in Price Sheet\n";
        cout << "11. Move P column (الكود) to H column in Price Sheet\n";
        cout << "12. Delete repeated (السعر) column (index 9) from Price Sheet\n";
        cout << "13. Delete first 6 columns from Price Sheet\n";
        cout << "14. Set home nursing services stock to 9000000 in App Sheet\n";
        cout << "15. Convert all nan values to 0 in App Sheet\n";
